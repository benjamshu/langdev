...
var Dictionary = {
    ...
    setup: function() {
        ...
        article_html += "<p><label for='input-filter'>filter:</label> <input id='input-filter' type='text' autocomplete='off' autofocus inputmode='latin' placeholder='enter search term…' required spellcheck='false'> <button id='input-button'>ok</button></p>";
        article_html += "</header>";
